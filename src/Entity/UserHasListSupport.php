 ...
 * )
 * @ORM\Entity(repositoryClass=UserHasListSupportRepository::class)
 * @ORM\Table(
 *     uniqueConstraints={
...
class UserHasListSupport
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="User", inversedBy="listSupports", cascade={"persist"})
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Support", inversedBy="usersLists", cascade={"persist"})
     * @ORM\JoinColumn(nullable=false)
